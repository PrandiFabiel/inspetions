...
function ListBrands() {
  ...
  //filtrar
  const [tablaBrand, setTablaBrand] = useState([]);
  ...
  const filtrar = (terminoBusqueda) => {
    var results = tablaBrand.filter((elemento) => {
      if (
        elemento.name
          .toString()
          .toLowerCase()
    ...
    <div className="divFa">
      ...
      <div style={{ height: "100vh" }} className="container row mt-5">
        <div className="col-md-11 container mt-5">
          <div className="row">
            <h1 className="col-md-10">Brands</h1>
          </div>
          <div className="row">
